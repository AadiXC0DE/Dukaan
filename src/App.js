        ...
        <div className="py-12 shadow mx-auto px-6 -mt-32 rounded-lg shadow-slate-200/50 bg-white w-[min(1024px,_100%)] ">
          <div className="w-[min(720px,_100%)] mx-auto flex flex-col items-start justify-start gap-6">
            ...
            <div className="flex-col flex items-stretch justify-start gap-2">
              ...
              <div className="border-2 border-black/20 px-2 flex flex-row items-center gap-12 justify-between focus-within:border-black/40 rounded w-[min(320px,_100%)] ">
                <input
                  ...
                  value="cozy"
                ></input>
                <button className="p-2 grid place-items-center focus:outline-none">
                  <img src={cross} alt="cross"></img>
                </button>
              </div>
            </div>
            <button className="rounded px-4 py-2 bg-[#146EB4] text-lg text-white font-Galano">
              Generate Slogans
            </button>
            ...
            <div className="w-full flex-row flex items-center justify-between gap-4">
              <div className="flex-1 flex-row flex items-center justify-center gap-4">
                <a
                  href="#"
                  className=" font-Galano rounded-full w-6 h-6 grid place-items-center bg-[#146EB4] text-white text-sm"
                >
                  1
                </a>
                <a
                  href="#"
                  className="font-Galano rounded full w-6 h-6 grid place-items-center text-[#146EB4] text-sm"
                >
                  2
                </a>
                <a
              ...
              <a href="#" className="flex text-[#146EB4] text-sm font-Galano">
